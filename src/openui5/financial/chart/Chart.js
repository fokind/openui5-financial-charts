        ...
        return Control.extend("openui5.financial.chart.Chart", {
            metadata: {
                ...
                aggregations: {
                    ...
                    series: {
                        type: "openui5.financial.chart.Series",
                        multiple: true,
                        singularName: "series",
                    },
                },
            ...
            addSeries: function (oObject) {
                this.addAggregation("series", oObject, true);
            },

            insertSeries: function (oObject, iIndex) {
                this.insertAggregation("series", oObject, iIndex, true);
            },

            removeSeries: function (vObject) {
                this.addAggregation("series", vObject, true);
            },

            removeAllSeries: function () {
                this.addAggregation("series", true);
            },
            ...
            _draw: function () {
                if (!this._fWidth || !this._fHeight || !this._fPaddingTop)
                    return;
                ...
                this.getAggregation("_timeAxis").setRange([
                    0,
                    this._fPlotAreaWidth,
                ]);
                ...
                this.getAggregation("_valueAxis").setRange([
                    this._fPlotAreaHeight,
                    0,
                ]);
            ...
            refresh: function () {
                ...
                this.getAggregation("_valueAxis").setDomain([
                    d3.min(aSeries, function (e) {
                        return e._getMin();
                    }),
                    d3.max(aSeries, function (e) {
                        return e._getMax();
                    }),
                ]);
